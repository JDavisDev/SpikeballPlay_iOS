...
//		let stringOne = ChallongeAPI.challongeBaseUrl
//		let stringTwo = ChallongeAPI.PERSONAL_API_KEY
//		let stringThree = "TESTNAMEHERE"
//		let finalString = stringOne +
//			"tournaments.json?api_key=" + stringTwo +
//		"&tournament[name]=" + stringThree
//
//		 let urlString = finalString
...
//						self.tournamentList.removeAll()
//						for obj in json {
//							self.tournamentList.append(obj.value(forKey: "tournament") as! String)
//						}
//
//						if(self.tournamentList.count > 0) {
//							self.parseTournaments()
